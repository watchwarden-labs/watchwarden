import { Bell, Clock, Database, Info, Key, Plus, RefreshCw } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Run a catch-up check when the controller starts if the last scheduled check was more
                than 24 hours ago
              </p>
            </div>
            <Switch
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            Register a new agent to connect a remote Docker host. Each agent gets a unique token for
            authentication.
          </p>
        </CardContent>
      </Card>
