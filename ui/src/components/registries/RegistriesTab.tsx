...
export function RegistriesTab() {
  ...
  const [editRegistry, setEditRegistry] = useState<RegistryCredential | null>(null);
  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        <Lock size={16} />
        <AlertDescription>
          Credentials are encrypted at rest. Agents receive them securely over WebSocket.
        </AlertDescription>
      </Alert>
      ...
      {registries.length === 0 ? (
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-12 gap-3">
            ...
            <p className="text-muted-foreground">No registry credentials configured</p>
            ...
            <TableBody>
              {registries.map((reg) => (
                <TableRow key={reg.id}>
                  ...
                  <TableCell>
                    <Badge variant={reg.auth_type === 'basic' ? 'secondary' : 'outline'}>
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              Agents will no longer be able to pull private images from this
                              registry.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
