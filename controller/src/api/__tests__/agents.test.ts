...
import { insertAgent, setConfig, updateAgentStatus, upsertContainers } from '../../db/queries.js';
...
describe('POST /api/agents/check-all', () => {
  ...
  it('returns 202 with count of online agents', async () => {
    ...
    const hub = (app as unknown as { hub: { sendToAgent: ReturnType<typeof vi.fn> } }).hub;
